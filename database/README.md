...
Demo verified ID-card assets live in `database/assets/pics/demo/id-cards/`. Upload those files into the public `pics` bucket preserving these object paths: `demo/id-cards/vn-verified-id-card.svg` and `demo/id-cards/jp-verified-id-card.svg`.
